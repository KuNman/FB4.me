...
<comment>Acme\MyClass</comment> having the identifier <comment>42</comment>:
  ...
  <info>php %command.full_name% --user=Symfony/Component/Security/Core/User.php/User.php:kevin VIEW EDIT Acme/MyClass:42</info>
...
To set permissions at the class scope, use the <info>--class-scope</info> option:
  ...
  <info>php %command.full_name% --class-scope --user=Symfony/Component/Security/Core/User.php/User.php:anne OWNER Acme/MyClass:42</info>
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (empty($userOption) && empty($roleOption)) {
            throw new \InvalidArgumentException('A Role or a User.php must be specified.');
        }
