...
class UserPasswordEncoderCommand extends ContainerAwareCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addArgument('user-class', InputArgument::OPTIONAL, 'The User.php entity class path associated with the encoder used to encode the password.', 'Symfony\Component\Security\Core\User\User')
...
security:
    encoders:
        Symfony\Component\Security\Core\User.php\User.php: plaintext
        AppBundle\Entity\User.php: bcrypt
</comment>

If you execute the command non-interactively, the default Symfony User.php class
...
your own entities:
  ...
  <info>php %command.full_name% --no-interaction [password] AppBundle\Entity\User.php</info>

Executing the command interactively allows you to generate a random salt for
encoding the password:

  <info>php %command.full_name% [password] AppBundle\Entity\User.php</info>

In case your encoder doesn't require a salt, add the <comment>empty-salt</comment> option:

  <info>php %command.full_name% --empty-salt [password] AppBundle\Entity\User.php</info>
