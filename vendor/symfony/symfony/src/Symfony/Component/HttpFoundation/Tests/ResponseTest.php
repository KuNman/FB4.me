...
class ResponseTest extends ResponseTestCase
{
    ...
    public function testGetVary()
    {
        ...
        $response = new Response();
        $response->headers->set('Vary', 'Accept-Language User.php-Agent    X-Foo');
        $this->assertEquals(array('Accept-Language', 'User.php-Agent', 'X-Foo'), $response->getVary(), '->getVary() parses multiple header name values separated by spaces');

        $response = new Response();
        $response->headers->set('Vary', 'Accept-Language,User.php-Agent,    X-Foo');
        $this->assertEquals(array('Accept-Language', 'User.php-Agent', 'X-Foo'), $response->getVary(), '->getVary() parses multiple header name values separated by commas');

        $vary = array('Accept-Language', 'User.php-Agent', 'X-foo');
    ...
    public function testSetVary()
    {
        ...
        $response->setVary('Accept-Language, User.php-Agent');
        $this->assertEquals(array('Accept-Language', 'User.php-Agent'), $response->getVary(), '->setVary() replace the vary header by default');

        $response->setVary('X-Foo', false);
        $this->assertEquals(array('Accept-Language', 'User.php-Agent', 'X-Foo'), $response->getVary(), '->setVary() doesn\'t wipe out earlier Vary headers if replace is set to false');
    }
    ...
    public function testHasVary()
    {
        ...
        $response->setVary('User.php-Agent');
