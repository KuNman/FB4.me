...
class EntityUserProviderTest extends TestCase
{
    ...
    /**
     * @group legacy
     * @expectedDeprecation Implementing Symfony\Component\Security\Core\User.php\UserProviderInterface in a Doctrine repository when using the entity provider is deprecated since version 2.8 and will not be supported in 3.0. Make the repository implement Symfony\Bridge\Doctrine\Security\User.php\UserLoaderInterface instead.
     */
     ...
     * @expectedExceptionMessage You must either make the "Symfony\Bridge\Doctrine\Tests\Fixtures\User.php" entity Doctrine Repository ("Doctrine\ORM\EntityRepository") implement "Symfony\Bridge\Doctrine\Security\User.php\UserLoaderInterface" or set the "property" option in the corresponding entity provider configuration.
     */
    ...
    public function testRefreshInvalidUser()
    {
        ...
        $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}(
            ...
            'User.php with id {"id1":1,"id2":2} not found'
        );
